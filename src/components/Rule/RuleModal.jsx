...
import classes from "./RuleModal.module.css";

const Backdrop = () => {
  return <div className={classes.backdrop}></div>;
};

const RuleOverlay = (props) => {
  return (
...
const e = document.getElementById("overlays");
const RuleModal = (props) => {
  return (
    <Fragment>
      {ReactDOM.createPortal(<Backdrop />, e)}
      {ReactDOM.createPortal(<RuleOverlay onClick={props.onClick} />, e)}
    </Fragment>
  );
};
